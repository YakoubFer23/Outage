 ...
 * Original file: /npm/simple-datatables@7.0.1/dist/umd/simple-datatables.js
 *
                        ...
                        (function () {
                            ...
                            const U = (t, e) => {
                                ...
                                W = (t, e, s, i, n) => {
                                    ...
                                    t.headings
                                        ? (a.headings = t.headings.map((t) =>
                                              J(t)
                                          ))
                                        : e?.tHead
                                        ? (a.headings = Array.from(
                                              e.tHead.querySelectorAll("th")
                                          ).map((t, e) => {
                                              const a = J(t.innerHTML);
                                              s[e] ||
                                                  (s[e] = {
                                                      type: i,
                                                      format: n,
                                    ...
                                    for (let t = 0; t < a.headings.length; t++)
                                        s[t] ||
                                            (s[t] = {
                                                type: i,
                                                format: n,
                            ...
                            (s.DataTable = class {
                                ...
                                search(t) {
                                    ...
                                    const e = this.columns.settings.map((e) => {
                                ...
                                setMessage(t) {
                                    ...
                                    this.wrapperDOM.classList.add(
                                        ...
                                        (this.totalPages = 0),
                                        this._renderPagers();
                                    let s = structuredClone(this._virtualDOM),
                                        i = s.childNodes?.find(
                                            (t) => "TBODY" === t.nodeName
                                        );
                                    if (
                                    ...
                                    const n = this._dd.diff(
                                        this._virtualDOM,
                                        s
                                    );
                                    this._dd.apply(this.dom, n),
                                        (this._virtualDOM = s);
                                }
                                on(t, e) {
...
//# sourceMappingURL=/sm/84fc05392ca9e84345170f372d0dbe480b0b75ad08aaab4607a6e05baf244c35.map
